...
export function CheckoutPage() {
  ...
  if (orderId) {
    if (!accessToken) {
      return <ContentCard><p className="text-destructive">Войдите в профиль, чтобы продолжить оплату заказа.</p><Link to="/authorization" className="mt-4 inline-block underline">Войти</Link></ContentCard>;
    }
