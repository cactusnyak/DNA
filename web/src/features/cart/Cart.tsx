...
import { CartAdItemsList } from '@/widgets/Cart/components/CartAdItemsList/CartAdItemsList';
import { CartEmptyState } from '@/widgets/Cart/components/CartEmptyState';
import { CartItemsList } from '@/widgets/Cart/components/CartItemsList';
import { CartSummary } from '@/widgets/Cart/components/CartSummary';
          ...
          {tab === 'products' && items.length > 0 && (
            <div className="space-y-4">
              ...
              <Button
                ...
                variant="destructive"
                size="sm"
                className="w-full sm:w-auto p-4 rounded-lg"
                onClick={clearCart}
              >
                Очистить товары
              </Button>
