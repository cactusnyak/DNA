...
function richDescription(text: string) {
  return {
...
async function main() {
  ...
  const products = await Promise.all([
    // Smartphones
    prisma.product.create({ data: { categoryId: catSmartphones.id, title: 'Samsung Galaxy S24 Ultra', slug: 'samsung-galaxy-s24-ultra', description: richDescription('Флагманский смартфон Samsung с мощным процессором Snapdragon 8 Gen 3, камерой 200 МП и S Pen. Экран 6.8" Dynamic AMOLED 2X, 120 Гц. Батарея 5000 мАч.'), price: 109990 } }),
    prisma.product.create({ data: { categoryId: catSmartphones.id, title: 'Apple iPhone 16 Pro Max', slug: 'apple-iphone-16-pro-max', description: richDescription('Лучший смартфон Apple с чипом A18 Pro, новой системой камер и улучшенным дисплеем ProMotion 120 Гц. 6.9 дюйма, 256 ГБ базовая версия.'), price: 139990 } }),
    prisma.product.create({ data: { categoryId: catSmartphones.id, title: 'Xiaomi 14 Pro', slug: 'xiaomi-14-pro', description: richDescription('Мощный флагман Xiaomi с камерой Leica, Snapdragon 8 Gen 3 и зарядкой 120 Вт. Ceramic Shield стекло, IP68.'), price: 79990 } }),
    prisma.product.create({ data: { categoryId: catSmartphones.id, title: 'POCO X6 Pro', slug: 'poco-x6-pro', description: richDescription('Игровой смартфон среднего класса с Dimensity 8300-Ultra, AMOLED 120 Гц и батареей 5100 мАч. Отличный выбор за разумные деньги.'), price: 32990 } }),

    // Laptops
    prisma.product.create({ data: { categoryId: catLaptops.id, title: 'Apple MacBook Pro 14" M4 Pro', slug: 'apple-macbook-pro-14-m4-pro', description: richDescription('Профессиональный ноутбук на чипе M4 Pro с 24 ГБ RAM, SSD 512 ГБ. Дисплей Liquid Retina XDR, до 22 часов работы от батареи.'), price: 219990 } }),
    prisma.product.create({ data: { categoryId: catLaptops.id, title: 'ASUS ROG Strix G16 2024', slug: 'asus-rog-strix-g16-2024', description: richDescription('Игровой ноутбук с RTX 4070, Intel Core i9-14900HX, 16 ГБ RAM, 1 ТБ SSD. 16" QHD+ 240 Гц. Мощь для максимальных настроек.'), price: 159990 } }),
    prisma.product.create({ data: { categoryId: catLaptops.id, title: 'Lenovo ThinkPad X1 Carbon Gen 12', slug: 'lenovo-thinkpad-x1-carbon-gen-12', description: richDescription('Бизнес-ноутбук весом 1.12 кг. Intel Core Ultra 7, 32 ГБ LPDDR5, 1 ТБ SSD. MIL-SPEC прочность, 14" IPS 2.8K.'), price: 189990 } }),
    prisma.product.create({ data: { categoryId: catLaptops.id, title: 'Acer Aspire 5 (2024)', slug: 'acer-aspire-5-2024', description: richDescription('Бюджетный ноутбук для работы и учёбы. AMD Ryzen 5 7530U, 16 ГБ RAM, 512 ГБ SSD. 15.6" FHD IPS.'), price: 54990 } }),

    // Audio
    prisma.product.create({ data: { categoryId: catAudio.id, title: 'Sony WH-1000XM5', slug: 'sony-wh-1000xm5', description: richDescription('Лучшие наушники с активным шумоподавлением. 30 часов работы, мультиподключение, Hi-Res Audio. Складная конструкция.'), price: 29990 } }),
    prisma.product.create({ data: { categoryId: catAudio.id, title: 'Apple AirPods Pro 2', slug: 'apple-airpods-pro-2', description: richDescription('Беспроводные наушники с адаптивным шумоподавлением, Transparency Mode и Personalized Spatial Audio. H2 чип.'), price: 24990 } }),
    prisma.product.create({ data: { categoryId: catAudio.id, title: 'JBL Charge 5', slug: 'jbl-charge-5', description: richDescription('Портативная Bluetooth-колонка с 20 часами работы, мощным басом, IPX7 водонепроницаемостью и функцией зарядки устройств.'), price: 13990 } }),

    // Tablets
    prisma.product.create({ data: { categoryId: catTablets.id, title: 'Apple iPad Pro 13" M4', slug: 'apple-ipad-pro-13-m4', description: richDescription('Мощнейший планшет с OLED-дисплеем Ultra Retina XDR, чипом M4 и поддержкой Apple Pencil Pro. 256 ГБ Wi-Fi.'), price: 149990 } }),
    prisma.product.create({ data: { categoryId: catTablets.id, title: 'Samsung Galaxy Tab S9 FE', slug: 'samsung-galaxy-tab-s9-fe', description: richDescription('Планшет с 10.9" TFT экраном, Exynos 1380, 6 ГБ RAM, 128 ГБ. IP68, S Pen в комплекте.'), price: 39990 } }),

    // Men Clothing
    prisma.product.create({ data: { categoryId: catMen.id, title: 'Пуховик мужской зимний Tommy Hilfiger', slug: 'pukhovik-muzhskoy-tommy-hilfiger', description: richDescription('Тёплый мужской пуховик из переработанного материала. Капюшон с мехом, водоотталкивающее покрытие. Размеры M–3XL.'), price: 24990 } }),
    prisma.product.create({ data: { categoryId: catMen.id, title: 'Джинсы Levi\'s 511 Slim', slug: 'dzhinsy-levis-511-slim', description: richDescription('Классические зауженные джинсы Levi\'s из эластичного денима. Комфортная посадка, 5 карманов. Размеры 28–38.'), price: 7990 } }),
    prisma.product.create({ data: { categoryId: catMen.id, title: 'Худи Stone Island', slug: 'khudi-stone-island', description: richDescription('Премиальная мужская толстовка из хлопкового флиса. Нашивка с компасом, карман кенгуру, капюшон на молнии.'), price: 18990 } }),

    // Women Clothing
    prisma.product.create({ data: { categoryId: catWomen.id, title: 'Пальто женское шерстяное Zara', slug: 'palto-zhenskoe-sherstyanoe-zara', description: richDescription('Элегантное двубортное пальто из шерстяной смеси. Приталенный силуэт, пуговицы-роговицы. Размеры XS–XL.'), price: 12990 } }),
    prisma.product.create({ data: { categoryId: catWomen.id, title: 'Платье-миди Pull&Bear', slug: 'plate-midi-pull-and-bear', description: richDescription('Лёгкое летнее платье-миди с цветочным принтом. V-образный вырез, эластичный пояс. 100% вискоза.'), price: 3990 } }),

    // Shoes
    prisma.product.create({ data: { categoryId: catShoes.id, title: 'Nike Air Max 270', slug: 'nike-air-max-270', description: richDescription('Культовые кроссовки с крупнейшей воздушной подушкой Air. Верх из сетки и синтетических материалов. Размеры 36–47.'), price: 11990 } }),
    prisma.product.create({ data: { categoryId: catShoes.id, title: 'Adidas Ultraboost 22', slug: 'adidas-ultraboost-22', description: richDescription('Беговые кроссовки с технологией Boost и верхом из Primeknit+. Отлично подходят и для повседневной носки. Унисекс.'), price: 13990 } }),
    prisma.product.create({ data: { categoryId: catShoes.id, title: 'UGG Classic Short Boot', slug: 'ugg-classic-short-boot', description: richDescription('Классические угги из натуральной овчины с подошвой Treadlite by UGG. Высота голенища 19 см. Размеры 35–43.'), price: 16990 } }),

    // Furniture
    prisma.product.create({ data: { categoryId: catFurniture.id, title: 'Диван угловой «Мадрид»', slug: 'divan-uglovoy-madrid', description: richDescription('Просторный угловой диван-кровать с ящиком для хранения. Обивка из рогожки, механизм дельфин. Размер: 270×160 см.'), price: 67990 } }),
    prisma.product.create({ data: { categoryId: catFurniture.id, title: 'Стул офисный IKEA Markus', slug: 'stul-ofisnyy-ikea-markus', description: richDescription('Эргономичный офисный стул с поясничной поддержкой, регулируемыми подлокотниками и высотой сиденья. Чёрный, ткань.'), price: 24990 } }),
    prisma.product.create({ data: { categoryId: catFurniture.id, title: 'Стеллаж IKEA Billy 80×202', slug: 'stellazh-ikea-billy', description: richDescription('Классический книжный стеллаж IKEA. Регулируемые полки, берёзовый шпон. Размер: 80×28×202 см.'), price: 5990 } }),

    // Kitchen
    prisma.product.create({ data: { categoryId: catKitchen.id, title: 'Кофемашина DeLonghi Magnifica Start', slug: 'kofemashina-delonghi-magnifica-start', description: richDescription('Автоматическая кофемашина с встроенной кофемолкой, капучинатором и 9 уровнями помола. Давление 15 бар.'), price: 44990 } }),
    prisma.product.create({ data: { categoryId: catKitchen.id, title: 'Набор ножей Victorinox Swiss Classic 6 пр.', slug: 'nabor-nozhey-victorinox-swiss-classic', description: richDescription('Профессиональный набор из 6 кухонных ножей с рукоятками Fibrox. Нержавеющая сталь, эргономичный дизайн.'), price: 8990 } }),

    // Fitness
    prisma.product.create({ data: { categoryId: catFitness.id, title: 'Гантели наборные 2×20 кг Kettler', slug: 'ganteli-nabornye-2x20kg-kettler', description: richDescription('Набор разборных гантелей с замком-зажимом. Стальной гриф с хромированием, резиновые блины. Вес каждой: до 20 кг.'), price: 12990 } }),
    prisma.product.create({ data: { categoryId: catFitness.id, title: 'Коврик для йоги Manduka PRO', slug: 'kovrik-dlya-yogi-manduka-pro', description: richDescription('Профессиональный коврик для йоги 6 мм толщиной. Нескользящее покрытие, размер 180×61 см. Пожизненная гарантия.'), price: 9990 } }),

    // Outdoor
    prisma.product.create({ data: { categoryId: catOutdoor.id, title: 'Палатка трёхместная Naturehike Cloud-Up 3', slug: 'palatka-trekhmestnaya-naturehike-cloud-up-3', description: richDescription('Лёгкая туристическая палатка весом 2.1 кг. Двуслойная конструкция, водостойкость HH 3000 мм, вестибюль.'), price: 18990 } }),
    prisma.product.create({ data: { categoryId: catOutdoor.id, title: 'Рюкзак туристический Osprey Atmos AG 65', slug: 'ryukzak-turisticheskiy-osprey-atmos-ag-65', description: richDescription('Рюкзак с системой Anti-Gravity, 65 л объём, дождевик в комплекте. Система регулировки спины, поясничный пояс.'), price: 27990 } }),

    // Kids
    prisma.product.create({ data: { categoryId: catKids.id, title: 'Конструктор LEGO Technic Bugatti Chiron', slug: 'konstruktor-lego-technic-bugatti-chiron', description: richDescription('Детальная модель Bugatti Chiron из 3599 деталей. Функционирующая коробка передач, подвеска, поршни. 14+.'), price: 24990 } }),
    prisma.product.create({ data: { categoryId: catKids.id, title: 'Велосипед детский Strider 14x Sport', slug: 'velosiped-detskiy-strider-14x-sport', description: richDescription('Беговел-трансформер 2 в 1: сначала беговел без педалей, потом педальный велосипед. Для детей 3–7 лет.'), price: 15990 } }),

    // Beauty
    prisma.product.create({ data: { categoryId: catBeauty.id, title: 'Набор ухода за кожей Clinique Dramatically Different', slug: 'nabor-ukhoda-klinik-dramatically-different', description: richDescription('Базовый набор для ежедневного ухода: очищающее средство, тоник, увлажняющий гель. Подходит для всех типов кожи.'), price: 6990 } }),
    prisma.product.create({ data: { categoryId: catBeauty.id, title: 'Парфюм Chanel Coco Mademoiselle 100 мл', slug: 'parfyum-chanel-coco-mademoiselle-100ml', description: richDescription('Культовый женский парфюм с нотами бергамота, пачули и розы. Eau de Parfum, флакон 100 мл.'), price: 18990 } }),
  ]);
  ...
  const ads = await Promise.all([
    // Estate
    prisma.ad.create({ data: { categoryId: adCatApartments.id, sellerId: seller1.id, title: '3-комнатная квартира у метро Проспект Мира', slug: '3-komnatnaya-kvartira-u-metro-prospekt-mira', description: richDescription('Продаётся просторная 3-комнатная квартира 87 кв. м на 7 этаже 14-этажного дома. Свежий евроремонт, встроенная кухня, два санузла. Развитая инфраструктура района, 5 минут до метро.'), price: 14500000, status: AdStatus.PUBLISHED } }),
    prisma.ad.create({ data: { categoryId: adCatRent.id, sellerId: seller2.id, title: 'Уютная студия в центре, посуточно', slug: 'uiutnaya-studiya-v-tsentre-posutochno', description: richDescription('Современная квартира-студия 32 кв. м с дизайнерским ремонтом. Wi-Fi, Smart TV, полностью оснащённая кухня. В 10 минутах от Красной площади. Цена от 3500 руб/сутки.'), price: 3500, status: AdStatus.PUBLISHED } }),
    prisma.ad.create({ data: { categoryId: adCatHouses.id, sellerId: seller1.id, title: 'Дача 6 соток в Подмосковье, 60 км от МКАД', slug: 'dacha-6-sotok-podmoskovye-60km', description: richDescription('Небольшой жилой дом 48 кв. м с баней, гаражом, плодовым садом. Газ и свет подключены. Асфальтовая дорога до участка. Хорошая экология, рядом озеро.'), price: 3200000, status: AdStatus.PUBLISHED } }),

    // Cars
    prisma.ad.create({ data: { categoryId: adCatCars.id, sellerId: seller1.id, title: 'Toyota Camry 2021, 2.5 AT, белый', slug: 'toyota-camry-2021-2-5-at-bely', description: richDescription('Toyota Camry 2021 г.в., 2.5 литра, автомат, белый. Пробег 54 000 км. Один владелец, обслуживалась у официального дилера. ПТС оригинал, не бита, не крашена. Комплектация Premium.'), price: 2850000, status: AdStatus.PUBLISHED } }),
    prisma.ad.create({ data: { categoryId: adCatCars.id, sellerId: seller2.id, title: 'Kia Rio 2020, 1.6 AT, серебро', slug: 'kia-rio-2020-1-6-at-serebro', description: richDescription('Kia Rio 2020 г.в., 1.6 л 123 л.с., автомат. Пробег 78 000 км. Продаю в связи с покупкой нового автомобиля. ТО пройдено, зимняя резина в подарок.'), price: 1190000, status: AdStatus.PUBLISHED } }),
    prisma.ad.create({ data: { categoryId: adCatMoto.id, sellerId: user1.id, title: 'Yamaha MT-07 2022, 689 куб. см', slug: 'yamaha-mt-07-2022-689-kub', description: richDescription('Мотоцикл Yamaha MT-07 2022 г.в. Пробег 12 500 км. Состояние отличное, небольшие царапины на крышке цилиндров. Мотозащита в комплекте. Зимнее хранение в отапливаемом гараже.'), price: 620000, status: AdStatus.PUBLISHED } }),

    // Electronics ads
    prisma.ad.create({ data: { categoryId: adCatPhones.id, sellerId: user1.id, title: 'iPhone 14 Pro, 256 ГБ, Deep Purple, б/у', slug: 'iphone-14-pro-256gb-deep-purple-bu', description: richDescription('Продаю iPhone 14 Pro 256 ГБ в отличном состоянии. Использовался 11 месяцев, всегда в чехле и под стеклом. АКБ 94%. Полный комплект: коробка, кабель, документы.'), price: 69990, status: AdStatus.PUBLISHED } }),
    prisma.ad.create({ data: { categoryId: adCatComputers.id, sellerId: seller1.id, title: 'MacBook Air M2 2022, 8/256 ГБ, Midnight', slug: 'macbook-air-m2-2022-8-256-midnight', description: richDescription('MacBook Air M2 2022, 8 ГБ RAM, 256 ГБ SSD, цвет Midnight. Использовался год, всегда был в чехле. Апскейлинг не делался. Батарея: 120 циклов. Коробка и документы в наличии.'), price: 89990, status: AdStatus.PUBLISHED } }),
    prisma.ad.create({ data: { categoryId: adCatComputers.id, sellerId: user2.id, title: 'Игровой ПК RTX 4070 + Ryzen 7 7700X', slug: 'igrovoy-pk-rtx-4070-ryzen-7-7700x', description: richDescription('Сборка 2023 г. RTX 4070 12 ГБ, Ryzen 7 7700X, 32 ГБ DDR5, SSD 1 ТБ NVMe, корпус Fractal Design, блок питания 750 Вт. Все на гарантии.'), price: 145000, status: AdStatus.PUBLISHED } }),

    // Work
    prisma.ad.create({ data: { categoryId: adCatIT.id, sellerId: seller2.id, title: 'Frontend-разработчик React, удалённо', slug: 'frontend-razrabotchik-react-udalenno', description: richDescription('Опыт 4 года. Стек: React, TypeScript, Next.js, GraphQL, TailwindCSS. Портфолио на GitHub. Готов к проектной работе или долгосрочному сотрудничеству. Ставка от 4000 руб/час.'), price: 4000, status: AdStatus.PUBLISHED } }),
    prisma.ad.create({ data: { categoryId: adCatDesign.id, sellerId: user2.id, title: 'Графический дизайнер, логотипы и брендинг', slug: 'graficheskiy-dizayner-logotipy-i-brending', description: richDescription('Создам логотип, фирменный стиль, упаковку. Опыт 6 лет. Работала с брендами в сфере HoReCa, fashion, beauty. Срок выполнения от 3 дней. Примеры работ в портфолио.'), price: 15000, status: AdStatus.PUBLISHED } }),

    // Services
    prisma.ad.create({ data: { categoryId: adCatRepair.id, sellerId: seller1.id, title: 'Ремонт квартир под ключ в Москве', slug: 'remont-kvartir-pod-kliuch-moskva', description: richDescription('Комплексный ремонт квартир: демонтаж, отделка, сантехника, электрика. Гарантия 2 года. Работаем с 2012 года, более 200 объектов. Бесплатный замер и смета.'), price: 6000, status: AdStatus.PUBLISHED } }),
    prisma.ad.create({ data: { categoryId: adCatBeautyService.id, sellerId: user1.id, title: 'Массаж релаксирующий, выезд на дом', slug: 'massazh-relaksiruyushchiy-vyezd-na-dom', description: richDescription('Профессиональный массаж у вас дома. Сертифицированный мастер, 7 лет практики. Виды: классический, спортивный, антицеллюлитный. Продолжительность 60–90 мин. Москва и ближайшее Подмосковье.'), price: 3500, status: AdStatus.PUBLISHED } }),

    // Hobby
    prisma.ad.create({ data: { categoryId: adCatHobby.id, sellerId: user2.id, title: 'Гитара электрическая Gibson Les Paul Standard', slug: 'gitara-elektrycheskaya-gibson-les-paul', description: richDescription('Gibson Les Paul Standard 2019 г., цвет Heritage Cherry Sunburst. Состояние 9/10, небольшие потёртости от игры. Хардкейс в комплекте. Возможна проверка у мастера.'), price: 180000, status: AdStatus.PUBLISHED } }),
    prisma.ad.create({ data: { categoryId: adCatHobby.id, sellerId: seller2.id, title: 'Велосипед горный Trek Marlin 5 2023', slug: 'velosiped-gorny-trek-marlin-5-2023', description: richDescription('Trek Marlin 5 2023. Размер рамы L (19"). Пробег около 800 км. Амортизационная вилка SR Suntour, 21 скорость Shimano. В отличном состоянии, продаю после переезда.'), price: 35000, status: AdStatus.PUBLISHED } }),

    // Moderation pending
    prisma.ad.create({ data: { categoryId: adCatPhones.id, sellerId: user3.id, title: 'Samsung Galaxy A54, 128 ГБ, лаванда', slug: 'samsung-galaxy-a54-128gb-lavanda', description: richDescription('Смартфон Samsung Galaxy A54 2023 г.в., 128 ГБ памяти, 6 ГБ RAM. Чехол и защитное стекло в комплекте. Отличное состояние, практически новый.'), price: 22000, status: AdStatus.PENDING_MODERATION } }),
    prisma.ad.create({ data: { categoryId: adCatApartments.id, sellerId: user3.id, title: '1-комнатная квартира, Новосибирск', slug: '1-komnatnaya-novosibirsk', description: richDescription('Продаётся 1-к квартира 38 кв. м на 4 этаже. Косметический ремонт, пластиковые окна, новые трубы. Рядом школа, детский сад, магазины. Ипотека возможна.'), price: 3500000, status: AdStatus.DRAFT } }),
  ]);
