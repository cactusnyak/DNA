...
const PRODUCTION_PRODUCTS: SeedProduct[] = [
  {
    ...
    description:
      'Курятник до 15 кур круглогодичный утеплённый вариант. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Кровля: профнастил C8. Сетка: оцинкованная, ячейка 25 × 25 мм. Комплектация: гнезда, насест, трап. Окно: 30 × 40 см. Цена (утеплённый): 55 000 ₽. Цена (летний): 50 000 ₽. Местоположение: Талдом.',
    price: 50000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 10 кур круглогодичный утеплённый вариант. Размер: 250 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Кровля: профнастил C8. Сетка: оцинкованная, ячейка 25 × 25 мм. Комплектация: гнезда, насест, трап. Цена (утеплённый): 45 000 ₽. Цена (летний): 40 000 ₽. Местоположение: Талдом.',
    price: 40000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 35 кур круглогодичный утеплённый вариант. Размер: 500 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Кровля: профнастил C8. Сетка: оцинкованная, ячейка 25 × 25 мм. Комплектация: гнезда, насест, трап. Цена (утеплённый): 115 000 ₽. Цена (летний): 98 000 ₽. Местоположение: Талдом.',
    price: 98000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 15 кур с покраской и полом. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Цена (утеплённый): 80 000 ₽. Цена (летний): 75 000 ₽. Местоположение: Талдом.',
    price: 75000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 15 кур с покраской. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Цена (утеплённый): 75 000 ₽. Цена (летний): 70 000 ₽. Местоположение: Талдом.',
    price: 70000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 7 кур. Размер: 300 × 100 × 160 см. Утеплитель 50 мм. Цена (утеплённый): 38 000 ₽. Цена (летний): 33 000 ₽. Местоположение: Талдом.',
    price: 33000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    title: 'Курятник до 7 кур',
    description:
      'Курятник до 7 кур. Размер: 200 × 110 × 120 см. Цена (утеплённый): 38 000 ₽. Цена (летний): 33 000 ₽.',
    price: 33000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    title: 'Курятник до 7 кур',
    description:
      'Курятник до 7 кур. Размер: 300 × 100 × 120 см. Цена (утеплённый): 43 000 ₽. Цена (летний): 38 000 ₽.',
    price: 38000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 20 кур Курятник зимний утеплённый. Размер: 300 × 140 × 180 см В полной комплектации. Цена (зимний): 75 000 ₽. Цена (летний): 70 000 ₽.',
    price: 70000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    title: 'Крольчатник',
    description:
      'Крольчатник Клетки для кроликов. Размер: 125 × 60 × 50 см. Цена: 6 990 ₽ ₽.',
    price: 6990,
    kind: 'rabbit-hutch',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Клетка для кроликов Деревянная клетка для кроликов. Размер: 120 × 60 × 60 см. Цена 6990. Местоположение: Талдом.',
    price: 6990,
    kind: 'rabbit-hutch',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник на 7-8 кур. Размер: 250 × 140 × 160 см Утепление 50 мм. Цена (зимний): 50 000 ₽. Цена (летний): 45 000 ₽.',
    price: 45000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 15 кур с полом. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Цена (утеплённый): 85 000 ₽. Цена (летний): 80 000 ₽. Местоположение: Талдом.',
    price: 80000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    title: 'Клетка для кроликов',
    description:
      'Клетка для кроликов. Размер изделий. Размер: 200 × 60 × 60 см в 3 яруса. Стоимость комплекса: 39 900 ₽.',
    price: 39900,
    kind: 'rabbit-hutch',
    images: [
      {
  ...
  },
  {
    ...
    title: 'Курятник до 15 кур с полом',
    description:
      'Курятник до 15 кур с полом. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Крыша: двускатная. Цена (утеплённый): 95 000 ₽. Цена (летний): 90 000 ₽. Местоположение: Талдом.',
    price: 90000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    title: 'Курятник до 15 кур с полом',
    description:
      'Курятник до 15 кур с полом. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Окно и дверца ПВХ. Цена (утеплённый): 90 000 ₽. Цена (летний): 85 000 ₽. Местоположение: Талдом.',
    price: 85000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник на 10 кур Выгул в пол. Размер: 300 × 140 × 160 см. Цена (зимний): 99 900 ₽. Цена (летний): 94 900 ₽.',
    price: 94900,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 15 кур с двускатной крышей. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Крыша: двускатная. Цена (утеплённый): 85 000 ₽. Цена (летний): 80 000 ₽. Местоположение: Талдом.',
    price: 80000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 15 кур с выносом под гнезда Небольшая модернизация. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм 🐣 настил в загоне, ваша птица всегда будет чистой и сухой, удобства уборки в загоне + защита от хищников 🐣Выносное гнездо: увеличение площади домика, удобное извлечение яиц, ящик утеплен и яйца в нем не замёрзнут. Цена (зимний): 88 000 ₽. Цена (летний): 83 000 ₽. Местоположение: Талдом.',
    price: 83000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 15 кур с покраской и двускатной крышей. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Цена (утеплённый): 80 000 ₽. Цена (летний): 75 000 ₽. Местоположение: Талдом.',
    price: 75000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 15 кур с покраской переносной. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Цена (утеплённый): 85 000 ₽. Цена (летний): 75 000 ₽. Местоположение: Талдом.',
    price: 75000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    title: 'Курятник до 15 кур с покраской двускат',
    description:
      'Курятник до 15 кур с покраской и двускатной крышей. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Крыша: двускатная, мягкая черепица. Цена (утеплённый): 85 000 ₽. Цена (летний): 75 000 ₽. Местоположение: Талдом.',
    price: 75000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    title: 'Курятник до 15 кур',
    description:
      'Курятник до 15 кур круглогодичный утеплённый вариант. Размер: 300 × 140 × 170 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Сетка: оцинкованная, ячейка 25 × 25 мм. Комплектация: гнезда, насест, трап. Цена (утеплённый): 75 000 ₽. Цена (летний): 70 000 ₽. Местоположение: Талдом.',
    price: 70000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Крольчатник / Клетка для кур 12 - местный комплекс в 3 яруса. Размер: 300 × 60 × 190 см Цена: 79 900 ₽.',
    price: 79900,
    kind: 'universal-cage',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 15 кур с тамбуром круглогодичный утеплённый вариант. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Кровля: профнастил C8. Сетка: оцинкованная, ячейка 25 × 25 мм. Комплектация: гнезда, насест, трап. Цена (утеплённый): 75 000 ₽. Цена (летний): 70 000 ₽. Местоположение: Талдом.',
    price: 70000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник на 10 кур с покраской круглогодичный утеплённый вариант. Размер: 250 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Кровля: профнастил C8. Сетка: оцинкованная, ячейка 25 × 25 мм. Комплектация: гнезда, насест, трап. Цена (утеплённый): 80 000 ₽. Цена (летний): 75 000 ₽. Местоположение: Талдом.',
    price: 75000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник на 7 кур с покраской Маленький но вполне вместительный домик на 7 курочек 🐣. Размер: 200 × 100 × 180 см Двускатная. Крыша Оснащён электрикой, пол в загоне ( дерево). Цена (зимний): 70 000 ₽. Цена (летний): 65 000 ₽.',
    price: 65000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    title: 'Курятник до 15 кур с покраской',
    description:
      'Курятник до 15 кур с покраской. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Цена (утеплённый): 80 000 ₽. Цена (летний): 75 000 ₽. Местоположение: Талдом.',
    price: 75000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник до 8 кур с покраской. Размер: 200 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Цена (утеплённый): 65 000 ₽. Цена (летний): 60 000 ₽. Местоположение: Талдом.',
    price: 60000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    title: 'Курятник на 10 кур с покраской',
    description:
      'Курятник на 10 кур с покраской. Размер: 250 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Цена (утеплённый): 70 000 ₽. Цена (летний): 65 000 ₽. Местоположение: Талдом.',
    price: 65000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    title: 'Курятник до 15 кур с выносом под гнезда',
    description:
      'Курятник до 15 кур с выносом под гнезда круглогодичный утеплённый вариант. Размер: 300 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Кровля: профнастил C8. Сетка: оцинкованная, ячейка 25 × 25 мм. Комплектация: гнезда, насест, трап. Цена (утеплённый): 65 000 ₽. Цена (летний): 60 000 ₽. Местоположение: Талдом.',
    price: 60000,
    kind: 'chicken-coop',
    images: [
      {
  ...
  },
  {
    ...
    description:
      'Курятник на 5 кур с покраской. Размер: 170 × 140 × 160 см. Каркас: брус сухой строганный. Внутренняя отделка: ОСП 9 мм. Наружная отделка: имитация бруса 16 × 140 мм. Утеплитель: 50 мм. Цена (утеплённый): 48 000 ₽. Цена (летний): 43 000 ₽. Местоположение: Талдом.',
    price: 43000,
    kind: 'chicken-coop',
    images: [
      {
...
function getProductAdditions(kind: ProductKind): Prisma.InputJsonValue {
  return kind === 'chicken-coop' ? CHICKEN_COOP_ADDITIONS : EMPTY_ADDITIONS;
}
...
async function importProduct(params: {
  ...
  const description = params.source.description.trim();
